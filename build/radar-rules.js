({ "81.cn":{ _name:"中国军网",
  ...
  "abbott.com":{ _name:"Abbott",
    www:[ { title:"Newsroom",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/en-us/corpnewsroom",
          "/en-us/corpnewsroom.html" ],
        target:"/abbott/news" } ] },
  "abbvie.com":{ _name:"AbbVie",
    news:[ { title:"News Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/index.php?s=2429" ],
        target:"/abbvie/news" } ] },
  ...
  "ahajournals.org":{ _name:"AHA Journals",
    www:[ { title:"Latest Articles",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/toc/:journal/0/0" ],
        target:"/ahajournals/toc/:journal" } ] },
  ...
  "astrazeneca.com":{ _name:"AstraZeneca",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/media-centre/press-releases.html" ],
        target:"/astrazeneca/press-releases" } ] },
  "asus.com":{ _name:"ASUS",
    www:[ { title:"BIOS",
        docs:"https://docs.rsshub.app/routes/program-update",
  ...
  "baxter.com":{ _name:"Baxter",
    www:[ { title:"Newsroom",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/baxter-newsroom" ],
        target:"/baxter/newsroom" } ] },
  ...
  "cardiovascularbusiness.com":{ _name:"Cardiovascular Business",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/news" ],
        target:"/cardiovascularbusiness/news" } ] },
  ...
  "ecust.edu.cn":{ _name:"华东理工大学",
    ...
    gschool:[ { title:"研究生院通知公告",
        ...
        source:[ "/12753/list.htm",
          "/" ],
        target:"/ecust/yjs" } ] },
  "edwards.com":{ _name:"Edwards Lifesciences",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/newsroom/press-releases" ],
        target:"/edwards/press-releases" },
      { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/newsroom" ],
        target:"/edwards/press-releases" } ] },
  "edwardsvacuum.com":{ _name:"Edwards Vacuum",
    www:[ { title:"News and Events",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/en-uk/news-and-events" ],
        target:"/edwardsvacuum/news" } ] },
  ...
  "escardio.org":{ _name:"European Society of Cardiology",
    www:[ { title:"News Room",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/news/news-room/" ],
        target:"/escardio/news-room" },
      { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/news/press/press-releases/" ],
        target:"/escardio/press-releases" } ] },
  ...
  "pcronline.com":{ _name:"EuroIntervention",
    eurointervention:[ { title:"Latest Issue",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/issues/latest",
          "/" ],
        target:"/eurointervention/latest" } ],
    www:[ { title:"PCR Press Releases",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/News/PCR-Press-Releases" ],
        target:"/pcronline/pcr-press-releases" },
      { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/News/Press-releases" ],
        target:"/pcronline/press-releases" } ] },
  ...
  "fda.gov":{ _name:"U.S. Food and Drug Administration",
    "www.accessdata":[ { title:"510(k) Premarket Notifications",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/scripts/cdrh/cfdocs/cfpmn/pmn.cfm" ],
        target:"/fda/510k" } ],
    ".":[ { title:"Unknown",
        docs:"https://docs.rsshub.app/routes/government",
    ...
    www:[ { title:"MedWatch Safety Alerts",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/safety/medwatch-fda-safety-information-and-adverse-event-reporting-program" ],
        target:"/fda/medwatch" },
      { title:"MedWatch Safety Alerts",
        docs:"https://docs.rsshub.app/routes/government",
        source:[ "/medical-devices/medical-device-recalls-and-early-alerts" ],
        target:"/fda/medwatch" } ] },
  "feng.com":{ _name:"威锋",
    ".":[ { title:"社区",
        docs:"https://docs.rsshub.app/routes/bbs",
  ...
  "gevernova.com":{ _name:"GE Vernova",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/news/media-hub" ],
        target:"/gevernova/press-releases" } ] },
  ...
  "globenewswire.com":{ _name:"GlobeNewsWire",
    www:[ { title:"Industry News",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/rss/list" ],
        target:"/globenewswire/industry/medical-equipment" } ] },
  ...
  "hdu.edu.cn":{ _name:"杭州电子科技大学",
    ...
    computer:[ { title:"计算机学院 - 通知公告",
      ...
      { title:"计算机学院 - 研究生通知",
        ...
        target:"/hdu/cs/pg" } ] },
  "heart.org":{ _name:"American Heart Association",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/en/news" ],
        target:"/heart/news" } ] },
  ...
  "lilly.com":{ _name:"Eli Lilly",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/news/press-releases",
          "/news-releases" ],
        target:"/lilly/press-releases" } ] },
  "line.me":{ _name:"LINE",
  ...
  "mashiro.best":{ _name:"Mashiro's Baumkuchen",
    ".":[ { title:"Blog",
        ...
        source:[ "/",
          "/:lang/" ],
        target:"/mashiro/:lang" } ] },
  "massdevice.com":{ _name:"MassDevice",
    www:[ { title:"Article Archive",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/massdevice-article-archive/" ],
        target:"/massdevice/article-archive" } ] },
  ...
  "mdpi.com":{ _name:"MDPI",
    www:[ { title:"Journal",
        ...
        source:[ "/journal/:journal" ],
        target:"/mdpi/:journal" } ] },
  "medicaldesignbriefs.com":{ _name:"Medical Design Briefs",
    www:[ { title:"Articles",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/mdb/topic/:topic" ],
        target:"/medicaldesignbriefs/:topic" },
      { title:"Articles",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/mdb/techbriefs" ],
        target:"/medicaldesignbriefs/techbriefs" },
      { title:"Articles",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/" ],
        target:"/medicaldesignbriefs/:topic?" } ] },
  ...
  "medscape.com":{ _name:"Medscape",
    www:[ { title:"Cardiology News",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/index/list_13471_0" ],
        target:"/medscape/cardiology" },
      { title:"Latest News",
        docs:"https://docs.rsshub.app/routes/journal",
        source:[ "/index/list_13470_0" ],
        target:"/medscape/latest-news" } ] },
  "medtechdive.com":{ _name:"MedTech Dive",
    www:[ { title:"Deep Dive",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/deep-dive/" ],
        target:"/medtechdive/deep-dive" },
      { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/new-media",
        source:[ "/press-release/" ],
        target:"/medtechdive/press-release" } ] },
  "medtronic.com":{ _name:"Medtronic",
    news:[ { title:"Business & Regional News",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/business-regional-news" ],
        target:"/medtronic/business-regional-news" },
      { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/press-releases" ],
        target:"/medtronic/press-releases" } ] },
  ...
  "microport.com":{ _name:"MicroPort",
    ".":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/news" ],
        target:"/microport/news" } ] },
  ...
  "novartis.com.cn":{ _name:"Novartis China",
    www:[ { title:"新闻发布",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/news/news-archive" ],
        target:"/novartis/cn/news" } ] },
  ...
  "pfizer.com":{ _name:"Pfizer",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/newsroom/press-releases" ],
        target:"/pfizer/press-releases" } ] },
  "philips.com":{ _name:"Philips",
    "www.usa":[ { title:"News",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/a-w/about/news/home" ],
        target:"/philips/news" } ] },
  ...
  "prnewswire.com":{ _name:"PR Newswire",
    www:[ { title:"News Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news-releases/health-latest-news/medical-equipment-list/" ],
        target:"/prnewswire/news/medical-equipment" },
      { title:"News Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news-releases/health-latest-news/pharmaceuticals-list/" ],
        target:"/prnewswire/news/pharmaceuticals" },
      { title:"News Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news-releases/health-latest-news/fda-approval-list/" ],
        target:"/prnewswire/news/fda-approval" },
      { title:"News Releases",
        docs:"https://docs.rsshub.app/routes/traditional-media",
        source:[ "/news-releases/health-latest-news/health-latest-news-list/" ],
        target:"/prnewswire/news/health" } ] },
  ...
  "rfi.fr":{ _name:"Radio France Internationale",
    ".":[ { title:"Generic News",
        ...
        source:[ "/*path" ],
        target:"/rfi/:path" } ] },
  "roche.com":{ _name:"Roche",
    www:[ { title:"Media Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/media/releases" ],
        target:"/roche/media/releases" } ] },
  ...
  "sanofi.com":{ _name:"Sanofi",
    www:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/en/media-room/press-releases" ],
        target:"/sanofi/press-releases" } ] },
  "sass.org.cn":{ _name:"上海社会科学院",
    gs:[ { title:"研究生院",
        ...
        target:"/sass/gs/:type" } ] },
  "scai.org":{ _name:"SCAI",
    www:[ { title:"Events Schedule",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/education-and-events/events-schedule" ],
        target:"/scai/events" } ] },
  ...
  "siemens.com":{ _name:"Siemens",
    press:[ { title:"Press Releases",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/global/en" ],
        target:"/siemens/press/global/en" } ] },
  ...
  "stryker.com":{ _name:"Stryker",
    www:[ { title:"News",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/us/en/about/news.html",
          "/us/en/about/news/index.html" ],
        target:"/stryker/news" } ] },
